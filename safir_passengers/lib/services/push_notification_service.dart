...
class PushNotificationService {
  ...
  // دریافت توکن امنیتی موقت OAuth2 از گوگل برای ارسال نوتیفیکیشن به رانندگان سفیر
  static Future<String> getAccessToken() async {
    try {
      ...
      print("خطا در دریافت توکن گوگل: $e");
      rethrow;
    }
  }
  ...
  static sendNotificationToSelectedDriver(
    ...
    print('توکن دستگاه راننده: $deviceToken');
    ...
    // بدنه نوتیفیکیشن اختصاصی برند سفیر
    final Map<String, dynamic> message = {
      'message': {
        'token': deviceToken,
        'notification': {
          'title': "درخواست سفر جدید از $userName",
          'body':
              "مبدأ: $pickUpAddress \nمقصد: $dropOffDesitinationAddress"
        },
        'data': {
          'tripID': tripID,
        }
    ...
    if (response.statusCode == 200) {
      print("نوتیفیکیشن با موفقیت به راننده سفیر ارسال شد.");
    } else {
      print('خطا در ارسال نوتیفیکیشن. کد ارور: ${response.statusCode}');
    }
  }
}
